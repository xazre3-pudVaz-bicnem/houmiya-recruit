...
export const metadata: Metadata = {
  title: 'よくある質問（FAQ）80問以上｜厚木市の設備工事求人Q&A｜宝宮設備',
  description:
    '宝宮設備への応募・転職に関するよくある質問（80問以上・17カテゴリ）。未経験・資格・給与・厚木市勤務・エアコン工事・給湯器交換・電気工事・キャリア・応募方法など全網羅。神奈川県厚木市の設備工事求人。',
  keywords: [
    '設備工事 求人 よくある質問',
    '設備工事 未経験 応募',
    '設備工事 資格 不要',
  ...
  openGraph: {
    title: 'よくある質問（FAQ）80問以上｜宝宮設備 採用サイト',
    description: '厚木市の設備工事求人に関するよくある質問80問以上・17カテゴリ。エアコン工事・給湯器交換・電気工事・厚木市勤務など全網羅。',
...
const faqCategories = [
  ...
  },
  {
    ...
    items: [
      {
        q: 'エアコン工事は体力的にきついですか？',
        a: '夏の繁忙期（6〜9月）は件数が多く、屋外作業で暑さを感じます。ただし残業なし・1日の件数は17時に終わる量に調整しているため、無理な働き方はしません。体は自然と慣れていきます。',
      },
      {
        q: 'エアコン工事で使う専門工具は何ですか？',
        a: 'フレアツール（冷媒配管のフレア加工）・真空ポンプ（エアパージ）・電動ドリル（壁穴あけ）・マニホールドゲージ（冷媒圧力確認）・モンキーレンチ・養生シートなどが主な工具です。すべて会社が準備します。',
      },
      {
        q: 'エアコン工事の繁忙期・閑散期はどう違いますか？',
        a: '6〜9月（夏）は取付件数が急増し、1日4〜5台を担当することもあります。2〜3月（春先の引越しシーズン）も需要が増えます。10〜1月は比較的落ち着いた件数で、技術の定着や資格勉強の時間を取りやすい時期です。',
      },
      {
        q: '冷媒取扱技術者はいつまでに取得するのが理想ですか？',
        a: '入社後6ヶ月〜1年以内を目安にしています。研修での実務経験と並行して受験準備を進めます。受験料・テキスト代・講習費用はすべて会社負担です。取得後は担当できる作業が増え、昇給の対象になります。',
      },
      {
        q: 'エアコンの種類によって作業難易度は変わりますか？',
        a: '壁掛けエアコン（住宅用）は最も多い作業で覚えやすい種類です。天井埋め込み型（業務用）や天吊り型は作業が複雑になりますが、入社初期は住宅用の壁掛けエアコンから始めます。段階的に複雑な機種も担当できるようになります。',
      },
    ],
  },
  {
    ...
    items: [
      {
        q: '給湯器交換は危険な仕事ですか？',
        a: 'ガスや水道を扱うため、安全手順を守ることが最重要です。研修でガス漏れ検知・水圧確認・安全な撤去手順を学びます。正しい手順を守れば危険はありませんが、最初は必ず先輩と一緒に作業します。',
      },
      {
        q: '給湯器交換に必要な資格は何ですか？',
        a: '都市ガスの配管に触る場合は「簡易内管施工士」などの資格が必要です。宝宮設備では関連資格の取得費用を全額会社負担します。入社後に段階的に取得できます。基本的な機器の交換作業は資格なしでも補助作業から始めることができます。',
      },
      {
        q: '給湯器交換は1件あたりどのくらいの時間がかかりますか？',
        a: '標準的な給湯器交換（同一タイプの入れ替え）は2〜4時間程度です。配管の状態・機種のタイプ・設置場所の条件によって前後します。1日に2〜3件担当します。慣れるにつれて作業効率が上がります。',
      },
      {
        q: '給湯器交換の需要が多い時期はいつですか？',
        a: '給湯器は冬（11〜2月）に使用頻度が上がり、老朽化による急な故障が増えます。この時期は交換依頼が集中します。エアコン工事と繁閑の時期が異なるため、宝宮設備では年間を通じて仕事量が安定しています。',
      },
      {
        q: 'ガス給湯器とエコキュートの違いは何ですか？',
        a: 'ガス給湯器はガスを使ってお湯を沸かす機器で、最も多い種類です。エコキュートは電気（ヒートポンプ）でお湯を沸かす機器で、省エネ目的での切り替え需要があります。工事の手順が異なりますが、両方を研修で学びます。',
      },
    ],
  },
  {
    ...
    items: [
      {
        q: '第二種電気工事士がなくても電気工事に携われますか？',
        a: '資格が必要な電気工事（100V・200V配線）は第二種電気工事士が必要です。入社後は補助作業からスタートし、並行して資格取得を進めます。試験は年2回あり、会社が費用を全額負担してサポートします。',
      },
      {
        q: '第二種電気工事士の試験はどのくらい難しいですか？',
        a: '合格率は筆記試験約60%、技能試験約70%程度です。参考書・練習キットで準備すれば独学でも合格できるレベルです。会社が練習材料の費用も負担します。試験前には業務スケジュールも配慮します。',
      },
      {
        q: '電気工事ではどんな作業を担当しますか？',
        a: '照明の取付・交換、コンセントの新設・増設、分電盤の取替え、エアコン専用回路の新設、スイッチ・配線工事などが主な作業です。住宅リフォームに伴う電気設備の更新作業が多く、厚木市・海老名市・伊勢原市などで依頼があります。',
      },
      {
        q: '電気工事は細かい作業が多いですか？',
        a: 'はい、配線の接続・絶縁処理・結線作業など細かい手作業が多い職種です。「丁寧に、正確に」作業するタイプの方に向いています。電気工事は目に見えない部分の品質が重要で、慎重さと集中力が求められます。',
      },
      {
        q: '電気工事士資格を取得すると給与はいくら上がりますか？',
        a: '具体的な金額は個人の技術・担当件数によりますが、第二種電気工事士取得後は担当できる電気工事の幅が大きく広がり、月給が数万円単位で見直されるケースがあります。詳細は面談時にお伝えします。',
      },
    ],
  },
  {
    ...
    items: [
      {
        q: '厚木市の本社から神奈川県全域の現場に行けますか？',
        a: '厚木市は神奈川県の中央部に位置し、東名厚木IC・圏央道厚木ICへのアクセスが良好です。海老名・大和・座間・伊勢原・平塚・相模原など各方向へ車で30〜60分圏内です。神奈川県全域の現場に効率よく対応できます。',
      },
      {
        q: '厚木市内の現場は多いですか？',
        a: '厚木市内は住宅地が多く、エアコン工事・給湯器交換・電気工事の依頼が安定して入ります。担当する現場の一定数が厚木市内または近隣の海老名市・大和市・座間市・伊勢原市です。',
      },
      {
        q: '厚木市内は車で移動しやすいですか？',
        a: '主要道路（国道129号・国道246号・東名高速道路）が通っており、市内・近隣市への移動はスムーズです。ただし朝の通勤時間帯は渋滞することもあります。本社出発が現場直行かどうかで移動時間が変わります。',
      },
      {
        q: '厚木市外から通勤することはできますか？',
        a: '海老名市・大和市・座間市・伊勢原市・相模原市など近隣市からの通勤者も在籍しています。本社（厚木市温水西）まで車で30分程度であれば通勤可能です。現場直行・直帰を活用することで毎日本社に来る必要はありません。',
      },
      {
        q: '厚木市の社宅・住居サポートはありますか？',
        a: '神奈川県外から転職・引越しを検討している方向けに、厚木市および近隣エリアでの住居探しサポートを行っています。「厚木市に引越して通勤したい」という方は面談時にご相談ください。個別に対応します。',
      },
    ],
  },
  {
