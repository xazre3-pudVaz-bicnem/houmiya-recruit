...
const faqItems = [
  ...
  { q: '勤務開始初日から社会保険に加入しますか？', a: 'はい、入社日から健康保険・厚生年金・雇用保険・労災保険のすべてに加入します。試用期間中も同条件です。保険証は加入手続き完了後に届きます。' },
  { q: '昼食補助の具体的な金額はいくらですか？', a: '金額の詳細は面接時にお伝えします。現場近くの飲食店・コンビニ・弁当店で使えます。毎日の昼食の自己負担を軽減するための制度です。' },
  { q: '資格を取っても昇給しない会社もあると聞きましたが、宝宮設備は確実に昇給しますか？', a: '資格取得は担当できる仕事の幅が広がるため、昇給の対象になります。「どの資格を取ったら月給がいくら上がるか」の目安は面接時に具体的にお伝えします。口約束ではなく、入社時に書面で確認できます。' },
  { q: '現場で作業中にケガをした場合の補償はありますか？', a: '労災保険に加入しているため、業務中のケガ・事故には労働者災害補償保険が適用されます。治療費・休業補償が対象です。安全帽・安全靴などの装備も会社から支給されます。' },
  { q: '年末年始・ゴールデンウィークの休みはありますか？', a: '年間休日については入社時の雇用契約書に明記されます。年末年始・GW・お盆など、業界の慣習に沿った休暇取得ができます。詳細は面接時にご確認ください。' },
]
    ...
    <>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          {/* FAQ */}
          <div className="mb-12">
            <h2 className="text-xl font-black text-navy tracking-tight mb-5 pb-3 border-b border-gray-200">福利厚生についてよくある質問（18問）</h2>
