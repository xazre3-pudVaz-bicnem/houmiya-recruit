...
const ROWS = [
  ...
  { label: '給与',       value: '月給 25万円〜（未経験：研修後 250,000円〜 / 経験者：技術に応じて要相談）' },
  { label: '昇給',       value: '技術・習熟度に応じて随時昇給あり' },
  { label: '賞与',       value: '夏季手当あり' },
  { label: '試用期間',   value: '1ヶ月（本採用と同条件）' },
  { label: '勤務地',     value: '神奈川県全域（拠点：厚木市妻田南2丁目7-21）' },
  { label: '勤務時間',   value: '8:30〜17:00（7時集合 / 残業あり）' },
  { label: '休日',       value: '夏季・冬季・お盆・年末年始休暇（月〜土勤務）' },
  { label: '応募資格',   value: '未経験可・要普通自動車免許（AT限定可）' },
  { label: '福利厚生',   value: '社会保険完備・車両貸出・昼食補助・資格取得支援・制服貸与・交通費支給・社宅相談可' },
]
